...
<head>
    ...
    <link rel="stylesheet" href="../admin dashboard/admin/dashboard.css">
...
<body>
        ...
        <div class="main-content">
            <aside class="sidebar">
                <ul>
                    ...
                    <li><button><a href="">ORDERS</a></button></li>
                    <li><button><a href="">ewan</a></button></li>
                    <li><button><a href="">ewan</a></button></li>
                    <li><button><a href="">ewan</a></button></li>
                </ul>
            </aside>
    ...
    <script src="../tracking/map.js"></script>
</body>
</html>
